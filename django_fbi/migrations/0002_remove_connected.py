...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'FacebookAccount.connected'
        db.delete_column('django_fbi_facebookaccount', 'connected')

        # Changing field 'FacebookAccount.api_data'
        db.alter_column('django_fbi_facebookaccount', 'api_data', self.gf('django.db.models.fields.TextField')(null=True))


    def backwards(self, orm):
        
        # Adding field 'FacebookAccount.connected'
        db.add_column('django_fbi_facebookaccount', 'connected', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'FacebookAccount.api_data'
        db.alter_column('django_fbi_facebookaccount', 'api_data', self.gf('django.db.models.fields.TextField')(default=''))
