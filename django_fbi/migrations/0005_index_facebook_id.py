...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding index on 'FacebookAccount', fields ['facebook_id']
        db.create_index('django_fbi_facebookaccount', ['facebook_id'])


    def backwards(self, orm):
        
        # Removing index on 'FacebookAccount', fields ['facebook_id']
        db.delete_index('django_fbi_facebookaccount', ['facebook_id'])
